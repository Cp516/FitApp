                ...
                <Grid.Row style={{ margin:'3%'}}>
                    ...
                    <Grid.Column >
                        <div>
                            ...
                            <p style={{lineHeight: '2.2'}}>The importance of staying organized and scheduling your workouts in advance cannot be stressed enough. By creating 
                            a daily and weekly schedule, you keep yourself motivated, stay focused and are in a better position to determine goals and measure your results. 
            ...
            <Grid columns={2} style={{padding:'2%', backgroundColor: 'white'}}>
                <Grid.Row style={{padding:'2%'}}>
                    <Grid.Column style={{textAlign: 'center'}}>
                        ...
                        <div>
                            ...
                            <p style={{color: '#868e96', fontSize:'14px'}}>Jason McCutchan is a Software Developer with FullStack Application Experience. He has Mentored and educated students in vanilla Javascript, 
                            Node, Angular, React, Redux and various other libraries and frameworks. Also conducted lectures and interviews relating to JS fundamentals and Machine Learning.</p>
                        </div>
                    </Grid.Column>
                    <Grid.Column style={{textAlign: 'center'}}>
                ...
                <Grid.Row style={{padding:'2%'}} >
                    <Grid.Column style={{textAlign: 'center'}}>
                        ...
                        <div>
                            <h3>Ethan Lipkind</h3>
                            <p style={{color: '#868e96', fontSize:'14px'}}>Ethan is a FullStack Engineer and has constructed APIs using GraphQL to improve runtime of queries and provide easy access to backend via a single endpoint, 
                            He has designed custom components using React Native with Flexbox for layout and AWS S3 buckets for storage. He is a backend wiz using SQL, KNEX, and Bookshelf.js to manage relational user data. 
                    ...
                    <Grid.Column style={{textAlign: 'center'}}>
                        ...
                        <div>
                            ...
                            <p style={{color: '#868e96', fontSize:'14px'}}>
                            Chris is a FullStack Engineer who has experienced in JavaScript, JQuery, AngularJs, React, Express, Node, MongoDb, MySQL, FireBase RealTime Databases and a number of other frameworks.
                ...
                <Grid.Row centered style={{backgroundColor: '#9d9d9d', height: '20vh', textAlign: 'center'}}>
                        ...
                        <Grid.Column style={{textAlign: 'center'}}>
                            <div>
                                <p style={{fontSize:'14px'}}>Fit Hero  Application By Team Aenean</p>
